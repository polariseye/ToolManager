...
namespace ToolManager.Utility
{
    ...
    public static class CheckUtil
    {
        ...
        public static void ArgumentNotNullOrEmpty(string value, string parameterName)
        {
            ...
            if (value.Length == 0)
                throw new ArgumentException(string.Format("argument:{0} can not be null", parameterName), parameterName);
        }
        ...
        public static void ArgumentNotNullOrEmptyOrWhitespace(string value, string parameterName)
        {
            ...
            if (value.IsWhiteSpace())
                throw new ArgumentException(string.Format("argument:{0} can not be whitespace", parameterName), parameterName);
        }
        ...
        {
            ArgumentNotNullOrEmptyForGenericCollection<T>(collection, parameterName, string.Format("argument {0} can not be null", parameterName));
        }
        ...
        {
            ArgumentNotNullOrEmptyForCollection(collection, parameterName, string.Format("argument {0} can not be empty", parameterName));
        }
