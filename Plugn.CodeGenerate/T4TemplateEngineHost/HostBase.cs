...
namespace Plugn.CodeGenerate.T4TemplateEngineHost
{
    ...
    public abstract class HostBase : MarshalByRefObject
    {
        ...
        public HostBase()
        {
            AddAssemblyLocation(typeof(TypeUtil).Assembly.Location);    // ToolManager.Utility.dll
            AddAssemblyLocation(typeof(HostBase).Assembly.Location);    // Plugn.CodeGenerate.dll
            ...
            AddNamespace("Plugn.CodeGenerate.Data");
            AddNamespace("Plugn.CodeGenerate.Data.SchemaObject");
            AddNamespace("Plugn.CodeGenerate.Data.DbSchemaProvider");
            AddNamespace("Plugn.CodeGenerate.Data.DbProvider");
