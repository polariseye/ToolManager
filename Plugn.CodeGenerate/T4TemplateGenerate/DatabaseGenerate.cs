...
namespace Plugn.CodeGenerate.T4TemplateGenerate
{
    ...
    /// 针对整个数据库生成
    /// </summary>
    public class DatabaseGenerate : GenerateBase
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public DatabaseGenerate(SODatabase database, List<SOTable> tableList, List<TemplateInfo> templateInfoList,
        ...
        public override Boolean Generate()
        {
            ...
            foreach (var templateItem in this.TemplateInfoList)
            {
                ...
                var errMsg = BuildTable(this.Database, templateItem, out fileName);
